	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal">
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="Name" class="form-control"
									id="Name_input" placeholder="请输入新闻标题">
									<span  class="help-block"></span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<label class="radio-inline"> <input type="radio"
									name="Kind" id="Kind1_input" value="M" checked="checked">
								<!-- values指定提交值 --> 工作资讯
								</label> <label class="radio-inline"> <input type="radio"
									name="Kind" id="Kind2_input" value="F"> 学习交流
								</label>
								</label> <label class="radio-inline"> <input type="radio"
									name="Kind" id="Kind3_input" value="X"> 生活资讯
								</label>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="Link" class="form-control"
									id="Link_input" placeholder="请输入新闻链接">
									<span  class="help-block"></span>
							</div>
						</div>
					</form>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-primary" id="user_uptate_btn">发布</button>
	...
	<div id="wrapper">
		...
		<nav class="navbar-default navbar-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					<li><a href="#" class="active-menu waves-effect waves-dark"><i class="fa fa-dashboard"></i> 全部新闻<span class="fa arrow"></span></a>
		...
		<div id="page-wrapper">
			<div class="header">
				...
				<button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal" style="position: absolute;top:60px;right:80px;">发布新闻</button>
				<ol class="breadcrumb">
					<li><a href="#">首页</a></li>
