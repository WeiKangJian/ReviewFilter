...
<body>
	...
	<div id="wrapper">
					...
					<li><a href="index.jsp" class="waves-effect waves-dark"><i class="fa fa-dashboard"></i> 全部新闻<span class="fa arrow"></span></a>
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav nav-second-level">
								<li><a href="gongzuozixun.jsp" class="active-menu waves-effect waves-dark"><i class="glyphicon glyphicon-road"></i>工作资讯</a></li>
		...
		<div id="page-wrapper">
			<div class="header">
				<h1 class="page-header">工作资讯</h1>
				<ol class="breadcrumb">
					<li><a href="#">首页</a></li>
					<li><a href="index.jsp">全部新闻</a></li>
					<li class="active">工作资讯</li>
				</ol>
			</div>
			<div id="page-inner">
				<div class="row">
	...
	function to_page(pn) {
			$.ajax({
				url : "/NewsManager2/gongzuozixun/news",
				data : "pn=" + pn,
				type : "GET",
				success : 
					function(result) {
