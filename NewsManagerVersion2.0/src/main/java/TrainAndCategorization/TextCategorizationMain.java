...
public class TextCategorizationMain  {
	...
	//1读入待分类文本集文件
	String dir="D:/workspace/NewsManager2/test/";
	...
	//3文本表示
	//读入特征词典文件
	String termDicFile="D:/workspace/NewsManager2/test/整合原始数据集termDic.txt";
	...
	String rangeFile="D:/workspace/NewsManager2/test/整合原始数据集SegmentTR.txt.range";
	...
	String modelFile="D:/workspace/NewsManager2/test/整合原始数据集SegmentTR.txt.scale.model";
...
//	System.out.println("result(1-2/1+2):"+(happy-unhappy)/(happy+unhappy)*100+"%");
	...
	public static void main(String args[]) throws IOException{
		...
		System.out.println(text.predict("你们好"));
	}
}